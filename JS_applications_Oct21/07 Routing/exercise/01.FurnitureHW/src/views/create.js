            ...
            <div class="row space-top">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.make ? ' is-invalid' : ' is-valid' ))} id="new-make" type="text" name="make">
                    </div>
                    <div class="form-group has-success">
                        <label class="form-control-label" for="new-model">Model</label>
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.model ? ' is-invalid' : ' is-valid' ))} id="new-model" type="text" name="model">
                    </div>
                    <div class="form-group has-danger">
                        <label class="form-control-label" for="new-year">Year</label>
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.year ? ' is-invalid' : ' is-valid' ))} id="new-year" type="number" name="year">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="new-description">Description</label>
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.description ? ' is-invalid' : ' is-valid' ))} id="new-description" type="text" name="description">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-control-label" for="new-price">Price</label>
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.price ? ' is-invalid' : ' is-valid' ))} id="new-price" type="number" name="price">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="new-image">Image</label>
                        <input class=${'form-control' + (Object.keys(errors).length === 0 ? '' : (errors.img ? ' is-invalid' : ' is-valid' ))} id="new-image" type="text" name="img">
                    </div>
                    <div class="form-group">
